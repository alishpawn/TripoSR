...
with gr.Blocks(title="TripoSR") as interface:
    ...
    **Tips:**
    1. If you upload a single photo, keep the subject centered and avoid extra scene clutter around it.
    2. If the result looks too bulky or too small, change the foreground ratio.
    3. It's better to disable "Remove Background" for the provided examples (except fot the last one) since they have been already preprocessed.
    4. Otherwise, please disable "Remove Background" only if your input image is RGBA with transparent background and the object already occupies most of the frame.
    """
    )
